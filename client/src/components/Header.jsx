  ...
  return (
    <header className="flex-shrink-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 z-10">
      <div className="px-6 h-16 flex items-center justify-between">
        {/* Lado Esquerdo: Botão de Menu e Barra de Busca */}
        <div className="flex items-center gap-4 flex-1">
          <button 
            onClick={onMenuClick} 
            className="p-2 -ml-2 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          <div className="relative w-full max-w-md">
            ...
            <input 
              ...
              placeholder="Busque por título..." // <-- TEXTO CORRIGIDO
              value={searchTerm}
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="p-2 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800"
          ...
          <button 
            ...
            className="px-4 py-2 flex items-center gap-2 bg-primary-600 text-white text-sm font-semibold rounded-lg hover:bg-primary-700 transition-all duration-200 shadow-sm hover:shadow-md"
          >
